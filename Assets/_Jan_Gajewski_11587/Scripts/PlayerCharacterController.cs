    ...
    void Update()
    {
        ...
        if (isGrounded && !wasGrounded)
        {
            ...
            if (recievesFallDamage && fallSpeedRatio > 0f)
            {
                ...
                // fall damage SFX
                AudioManager.Instance.PlayRandomHitClip(transform.position);
                //audioSource.PlayOneShot(fallDamageSFX);
            }
            else
            {
                // land SFX
                audioSource.PlayOneShot(landSFXs.GetRandomItem());
            }
        }
            ...
            if (isGrounded)
            {
                ...
                if (isGrounded && m_InputHandler.GetJumpInputDown())
                {
                    ...
                    if (SetCrouchingState(false, false))
                    {
                        ...
                        // play sound
                        audioSource.PlayOneShot(jumpSFXs.GetRandomItem());
                ...
                if (m_footstepDistanceCounter >= 1f / chosenFootstepSFXFrequency)
                {
                    ...
                    audioSource.PlayOneShot(footstepSFXs.GetRandomItem());
                }
